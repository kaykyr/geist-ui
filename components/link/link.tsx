...
>(
	(
		...
		const hoverColor =
			color || block ? theme.palette.successLight : 'inherit'
		...
		return (
			<a className={classes} href={href} {...props} ref={ref}>
				...
				<style jsx>{`
					...
					.block {
						padding: ${SCALES.pt(0.125)} ${SCALES.pr(0.25)}
							${SCALES.pb(0.125)} ${SCALES.pl(0.25)};
						margin: ${SCALES.mt(0)} ${SCALES.mr(-0.125)}
							${SCALES.mb(0)} ${SCALES.ml(-0.125)};
					}
