			...
			<div className="content">
				{isChinese ? (
					...
					<>
						...
						<Text>
							Here&#39;s a preview of your changes to the Theme.
							When you set the changes, the entire document site
				...
				<Text>
					...
					allows the server to <Code>push</Code> content, that is, to
					respond with data for more queries than the client
					requested. This allows the server to supply data it knows a
					web browser will need to render a web page, without waiting
					for the browser to examine the first response, and without
					the overhead of an additional request cycle.
				</Text>
